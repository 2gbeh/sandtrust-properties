...
include_once 'src/act_admin_refs.php';
      ...
      <table border="0">
        <caption>
          <form onsubmit="return false" autocomplete="off">
            <input type="search" name="q" placeholder="Search Username..." list="dl_username" onChange="location.assign(`?q=${this.value}`)" required />
            <?php echo $dl_username; ?>
          </form>
        </caption>
        <thead>
        <tr>
